...
def delete_user(id, password):
    try:
        ...
        if row_affect == 1:
            return jsonify(
                {"message": "Delete user Successfully!", "token": row_affect}
            )
        elif row_affect == -1:
            return jsonify({"message": "Confirm password failed!", "token": row_affect})
        elif row_affect == -2:
            return jsonify({"message": "User not found!", "token": row_affect})
        else:
            return jsonify({"message": "Delete user failed!", "token": row_affect})
...
def delete_language(id):
    try:
        ...
        if row_affect == 1:
            return jsonify(
                {"message": "Delete language Successfully!", "token": row_affect}
            )
        else:
            return jsonify({"message": "Delete language failed!", "token": row_affect})
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)})
...
def setenable_user(id):
    try:
        ...
        if row_affect == 1:
            return jsonify(
                {"message": "Change user state Successfully!", "token": row_affect}
            )
        elif row_affect == -2:
            return jsonify({"message": "User not found!", "token": row_affect})
        else:
            return jsonify(
                {"message": "Change user state failed!", "token": row_affect}
            )
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)})
...
def get_languagebyuser(username):
    try:
        ...
        if language:
            return jsonify(
                {"message": "Languages found Successfully!", "token": language}
            )
        else:
            return jsonify({"message": "Language not found!", "token": None})
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)}), 500
...
def get_educationbyid(id):
    try:
        ...
        if eduaction:
            return jsonify(
                {"message": "Education found Successfully!", "token": eduaction}
            )
        else:
            return jsonify({"message": "Language not found!", "token": None})
    except Exception as ex:
...
def create_education():
    try:
        ...
        if education is None:
            ...
            return jsonify(
                {"message": "Education created successfully!", "token": education}
            )
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)}), 500
...
def update_education(id):
    try:
        ...
        if education is None:
            ...
            return jsonify(
                {"message": "Education Update successfully!", "token": education}
            )
    except Exception as ex:
        return jsonify({"error": "Error {0}".format(ex), "message": "Error!"}), 500
...
def delete_education(id):
    try:
        ...
        if row_affect == 1:
            return jsonify(
                {"message": "Delete education Successfully!", "token": row_affect}
            )
        else:
            return jsonify({"message": "Delete education failed!", "token": row_affect})
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)})
...
def get_languagebyid(id):
    try:
        ...
        if language:
            return jsonify(
                {"message": "Language found Successfully!", "token": language}
            )
        else:
            return jsonify({"message": "Language not found!", "token": None})
    except Exception as ex:
...
def create_language():
    try:
        ...
        if language is None:
            ...
            return jsonify({"message": "Language exist on database!", "token": None})
        else:
            return jsonify(
                {"message": "Language created successfully!", "token": language}
            )
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)}), 500
...
def update_languagelearn(id):
    try:
        ...
        if language is None:
            ...
            return jsonify(
                {"message": "Language Update successfully!", "token": language}
            )
    except Exception as ex:
        return (
            jsonify(
                {
                    "error": "Error {0}".format(ex),
                    "message": "Card id or email exist on database!",
                }
            ),
            500,
        )
...
def get_userbyusername(username):
    try:
        ...
        if user:
            return jsonify({"message": "User found Successfully!", "token": user})
        else:
...
def login_user(id_user, password):
    try:
        ...
        if user == 2 or user == -1:
            return jsonify(
                {"message": "Username or password are incorrect!", "token": None}
            )
        elif user == 1:
            return jsonify({"message": "User Inactive!", "token": None})
        else:
            a = load_user(id_user)
...
def change_password(id):
    try:
        ...
        if row == 1:
            return jsonify({"message": "Change password", "token": 1})
        elif row == 3:
            return jsonify({"message": "Password incorrect!", "token": None})
        elif row == 2:
            return jsonify({"message": "Confirm password incorrect!", "token": None})
        elif row == 4:
            return jsonify(
                {"message": "Enter a key different at the old password!", "token": None}
            )
        else:
            return jsonify({"message": "User not found!", "token": None})
    except Exception as ex:
...
def create_user():
    try:
        ...
        if usuario is None:
            ...
            return jsonify({"message": "User exist on database!", "token": None})
        else:
            return jsonify({"message": "User created successfully!", "token": usuario})
    except Exception as ex:
        return jsonify({"message": "Error {0}".format(ex)}), 500
...
def update_user(id):
    try:
        ...
        if user is None:
            ...
            return jsonify(
                {"message": "User with email exist on database!", "token": None}
            )
        else:
            return jsonify({"message": "User was updated successfully!", "token": user})
    except Exception as ex:
        return (
            jsonify(
                {
