...
create table language_type(
	id_langtype integer identity not null,
...
create table language_programming(
	id_language integer identity not null,
...
create table knowledge_level(
	id_knowledge_level integer identity not null,
...
create table language_learned(
	id_langlearn integer identity not null,
...
alter table language_learned alter column description varchar(500);
...
id_education integer identity not null,
